/*
 * Live2D Widget
 * https://github.com/albertyang666/live2d-widget
 */
	...
	(function registerEventListener() {
		...
		document.querySelector("#waifu-tool .fa-paper-plane").addEventListener("click", () => {
			if (window.Asteroids) {
				...
				script.src = "https://cdn.jsdelivr.net/gh/albertyang666/asteroids/asteroids.js";
		...
		document.querySelector("#waifu-tool .fa-info-circle").addEventListener("click", () => {
			open("https://github.com/albertyang666/live2d-widget");
		});
